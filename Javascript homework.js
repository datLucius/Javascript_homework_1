...
[b] First, the code assigns 'letter' to 'x', then proceeds to 'setTimeout' in which a one second delay begins. During the delay, the code says to reassign 'letter' to 'z' and print it in the log. A second after 'The letter is z' is printed in the log, setTimout goes to work, reassigning 'letter' to 'y' and prints the message in the log
...
//If no input is given, the function adds no number to 0. It interprets that as NaN.//
...
takes a character (i.e. a string of length 1) and returns true if it
